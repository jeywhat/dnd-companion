...
export const en = {
  ...
  // ── Whiteboard (Map) ──────────────────────────────────────────────────────────
  "nav.whiteboard"                       : "Map",
  "whiteboard.title"                     : "Battle Map",
  "whiteboard.empty"                     : "Empty board — GM can import maps.",
  "whiteboard.emptyPlayer"               : "The GM hasn't loaded a map yet.",
  "whiteboard.toolbar.addMap"            : "📂 Add Map",
  "whiteboard.toolbar.addMapUrl"         : "🔗 Map URL",
  "whiteboard.toolbar.clearMaps"         : "🗑️ Clear Maps",
  "whiteboard.toolbar.addToken"          : "➕ Add Token",
  "whiteboard.toolbar.clearTokens"       : "🧹 Clear Tokens",
  "whiteboard.toolbar.syncCamera"        : "📡 Sync player view",
  "whiteboard.toolbar.unsyncCamera"      : "📡 Free player view",
  "whiteboard.toolbar.resetView"         : "🔄 Reset view",
  "whiteboard.tool.select"               : "Select (tokens)",
  "whiteboard.tool.pan"                  : "Pan view",
  "whiteboard.tool.map"                  : "Move maps",
  "whiteboard.gridSnap"                  : "Grid snap",
  "whiteboard.zoom"                      : "Zoom: {pct}%",
  "whiteboard.token.player"              : "Player",
  "whiteboard.token.monster"             : "Monster",
  "whiteboard.token.delete"              : "Delete",
  "whiteboard.token.lock"                : "Lock",
  "whiteboard.token.unlock"              : "Unlock",
  "whiteboard.modal.addToken.title"      : "New Token",
  "whiteboard.modal.addToken.name"       : "Name",
  "whiteboard.modal.addToken.namePlaceholder" : "Goblin, Orc…",
  "whiteboard.modal.addToken.type"       : "Type",
  "whiteboard.modal.addToken.color"      : "Color",
  "whiteboard.modal.addToken.owner"      : "Owner",
  "whiteboard.modal.addToken.ownerNone"  : "— GM —",
  "whiteboard.modal.addToken.submit"     : "Create",
  "whiteboard.modal.addToken.cancel"     : "Cancel",
  "whiteboard.modal.addMapUrl.title"     : "Import map from URL",
  "whiteboard.modal.addMapUrl.placeholder" : "https://example.com/map.jpg",
  "whiteboard.modal.addMapUrl.widthLabel" : "Width (cells)",
  "whiteboard.modal.addMapUrl.submit"    : "Add",
  "whiteboard.modal.addMapUrl.cancel"    : "Cancel",
  "whiteboard.status.mapAdded"           : "Map added: {name}.",
  "whiteboard.status.mapDeleted"         : "Map deleted.",
  "whiteboard.status.mapsCleared"        : "All maps cleared.",
  "whiteboard.status.tokenAdded"         : "Token \"{name}\" added.",
  "whiteboard.status.tokenDeleted"       : "Token deleted.",
  "whiteboard.status.tokensCleared"      : "All tokens cleared.",
  "whiteboard.status.notGm"             : "Only the GM can perform this action.",
  "whiteboard.status.noRoom"            : "Join a room to use the map.",
  "whiteboard.status.locked"            : "This token is locked.",
  "whiteboard.status.notOwner"          : "You can only move your own token.",
  "whiteboard.status.fileTooLarge"      : "File too large (max 2 MB).",
  "whiteboard.status.cameraSynced"      : "View synced with players.",
  "whiteboard.status.cameraFreed"       : "Player view freed.",
  "whiteboard.confirm.clearMaps"        : "Remove all maps from the board?",
  "whiteboard.confirm.clearTokens"      : "Remove all tokens?",
  "whiteboard.myToken"                  : "My token",
  "whiteboard.dragHint"                 : "Drag your token onto the map",
};
