...
export const en = {
  ...
  "settings.sync.cloudinaryCloudNameLabel": "Cloudinary Cloud Name (for MP3)",
  "settings.sync.cloudinaryCloudNamePlaceholder": "my-cloud-name",
  "settings.sync.cloudinaryPresetLabel": "Cloudinary Upload Preset",
  "settings.sync.cloudinaryPresetPlaceholder": "jdr-free",
  "settings.sync.cloudinaryNote": "Free 25 GB — cloudinary.com → Settings → Upload → Unsigned preset.",
  ...
  "audio.status.noCloudinary"  : "Configure Cloudinary (Cloud Name + Preset) in settings.",
};
