...
export const en = {
  ...
  "inventory.subtitle"           : "Manage your bags and items.",
  "inventory.weight"             : "Weight: {value} kg",
  "inventory.itemCount"          : "{count} item(s)",
  "inventory.slotsUsed"          : "slots used",
  "inventory.empty"              : "No containers. Add a bag to get started!",
  "inventory.removeItem"         : "Remove item",
  "inventory.removeContainer"    : "Remove this container",
  "inventory.resize"             : "Resize",
  "inventory.palette.title"      : "Available Items",
  "inventory.palette.subtitle"   : "Drag an item onto the grid or click it.",
  "inventory.custom.title"       : "Custom Item",
  "inventory.custom.subtitle"    : "Create a custom item.",
  "inventory.custom.name"        : "Name",
  "inventory.custom.namePlaceholder" : "E.g. Hemp Rope",
  "inventory.custom.emoji"       : "Icon",
  "inventory.custom.width"       : "Width",
  "inventory.custom.height"      : "Height",
  "inventory.custom.weight"      : "Weight (kg)",
  "inventory.custom.addButton"   : "➕ Add",
  "inventory.addContainer.title"    : "Add a Container",
  "inventory.addContainer.subtitle" : "Choose a bag type to add.",
  "inventory.actions.export"     : "Export",
  "inventory.actions.import"     : "Load JSON",
  "inventory.actions.clear"      : "Clear All",
  "inventory.status.itemAdded"   : "Item added to inventory.",
  "inventory.status.itemRemoved" : "Item removed from inventory.",
  "inventory.status.cleared"     : "Inventory cleared.",
  "inventory.status.exported"    : "Inventory exported successfully.",
  "inventory.status.imported"    : "Inventory imported successfully.",
  "inventory.status.containerAdded"   : "Container added.",
  "inventory.status.containerRemoved" : "Container removed.",
  "inventory.status.resized"     : "{name} resized.",
  "inventory.error.gridFull"     : "No space left in this container.",
  "inventory.error.noContainer"  : "No container available.",
  "inventory.error.invalidFile"  : "Invalid inventory file.",
  "inventory.error.importFailed" : "Import error: {error}",
  "inventory.error.nameRequired" : "Item name is required.",
  "inventory.confirm.clear"      : "Remove all containers and items?",
  "inventory.confirm.import"     : "Import {count} item(s)? Current inventory will be replaced.",
  "inventory.confirm.removeContainer"      : "Remove \"{name}\" (empty)?",
  "inventory.confirm.removeContainerItems" : "Remove \"{name}\" and its {count} item(s)?",
  "inventory.confirm.resizeLoseItems"      : "{count} item(s) overflow the new size and will be lost. Continue?",
  "inventory.container.pockets"    : "Pockets",
  "inventory.container.pouch"      : "Pouch",
  "inventory.container.backpack"   : "Backpack",
  "inventory.container.largeBag"   : "Large Bag",
  "inventory.container.bagHolding" : "Bag of Holding",
  "inventory.item.potion"        : "Health Potion",
  "inventory.item.staff"         : "Staff",
  "inventory.item.relic"         : "Relic",
  "inventory.item.sword"         : "Sword",
  "inventory.item.shield"        : "Shield",
  "inventory.item.scroll"        : "Scroll",
  "inventory.item.torch"         : "Torch",
  "inventory.item.ring"          : "Ring",
  "inventory.item.helmet"        : "Helmet",
  "inventory.item.gem"           : "Gem",
};
