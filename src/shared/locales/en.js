...
export const en = {
  ...
  "nav.carte"              : "Map",
  "carte.addPlayer"        : "Add player token",
  "carte.addMonster"       : "Add monster token",
  "carte.addNpc"           : "Add NPC token",
  "carte.toggleGrid"       : "Toggle grid",
  "carte.toggleSnap"       : "Toggle snap-to-grid",
  "carte.snapOn"           : "On",
  "carte.snapOff"          : "Off",
  "carte.zoomIn"           : "Zoom in",
  "carte.zoomOut"          : "Zoom out",
  "carte.resetView"        : "Reset view",
  "carte.tokenAdded"       : "{type} token added.",
  "carte.tokenDeleted"     : "Token \"{name}\" deleted.",
  "carte.noPermission"     : "You cannot move this token.",
  "carte.myToken"          : "My token",
  "carte.placeMyToken"     : "Place my token",
  "carte.centerMyToken"    : "Center on my token",
  "carte.myTokenPlaced"    : "Your token has been placed on the map.",
  "carte.deleteToken"      : "Delete selected token",
  "carte.clearBoard"       : "Clear board",
  "carte.confirmClear"     : "Clear everything? All maps and tokens will be removed.",
  "carte.boardCleared"     : "Board cleared.",
  "carte.saveView"         : "Save view",
  "carte.viewSaved"        : "View saved.",
  "carte.dropHint"         : "Drop image here",
  "carte.mapAdded"         : "Map \"{name}\" added.",
  "carte.mapError"         : "Error loading image.",
  "carte.toggleMinimap"    : "Toggle mini-map",
