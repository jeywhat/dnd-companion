...
export const fr = {
  ...
  "settings.sync.cloudinaryCloudNameLabel": "Cloudinary Cloud Name (pour MP3)",
  "settings.sync.cloudinaryCloudNamePlaceholder": "mon-cloud-name",
  "settings.sync.cloudinaryPresetLabel": "Cloudinary Upload Preset",
  "settings.sync.cloudinaryPresetPlaceholder": "jdr-free",
  "settings.sync.cloudinaryNote": "Gratuit 25 Go — cloudinary.com → Settings → Upload → Unsigned preset.",
  ...
  "audio.status.noCloudinary"  : "Configurez Cloudinary (Cloud Name + Preset) dans les paramètres.",
};
