...
export const fr = {
  ...
  "inventory.subtitle"           : "Gérez votre sac à dos (8×4 emplacements).",
  ...
  "inventory.error.gridFull"     : "Plus de place dans l'inventaire.",
  ...
  "inventory.confirm.clear"      : "Vider tout l'inventaire ?",
