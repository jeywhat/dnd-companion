...
export const fr = {
  ...
  "confirm.banMember": "Bannir {name} ? Il ne pourra plus rejoindre avec ce code.",
  // ── Combat tracker (MJ) ──────────────────────────────────────────────────────
  "nav.combatGm"                     : "Combat MJ",
  "combatTracker.section.ariaLabel"  : "Suivi du combat",
  "combatTracker.idle.title"         : "Prêt au combat",
  "combatTracker.idle.desc"          : "Déclenchez un lancer d'initiative pour démarrer le suivi du combat.",
  "combatTracker.trigger"            : "⚔️ Déclencher l'initiative",
  "combatTracker.rolling.title"      : "Initiative en cours…",
  "combatTracker.rolled"             : "{count}/{total} joueurs prêts",
  "combatTracker.addMonster"         : "Ajouter un monstre",
  "combatTracker.monsterNamePlaceholder": "Gobelin, Dragon…",
  "combatTracker.monsterInitiative"  : "Init",
  "combatTracker.monsterHp"         : "PV max",
  "combatTracker.addMonsterBtn"      : "+ Ajouter",
  "combatTracker.startCombat"        : "🗡️ Commencer le combat",
  "combatTracker.nextTurn"           : "➡️ Tour suivant",
  "combatTracker.endCombat"          : "🏁 Fin du combat",
  "combatTracker.round"              : "Round {n}",
  "combatTracker.turn"               : "Tour de {name}",
  ...
  "initiative.modal.dexMod"    : "Modificateur DEX : {mod}",
  "initiative.modal.rollBtn"   : "🎲 Lancer le d20",
  "initiative.modal.result"    : "d20 : {d20}  •  DEX : {mod}  =  {total}",
  "initiative.modal.confirmBtn": "✅ Confirmer",
  // ── Status combat ────────────────────────────────────────────────────────────
  "status.initiativeTriggered" : "⚔️ Initiative déclenchée ! Les joueurs doivent lancer.",
  "status.monsterAdded"        : "Monstre \"{name}\" ajouté.",
  "status.combatStarted"       : "⚔️ Le combat commence ! Round 1.",
  "status.combatEnded"         : "🏁 Combat terminé.",
  "status.initiativeSubmitted" : "Initiative soumise : {total}.",
  "status.nextTurn"            : "Tour de {name} (Round {round}).",
  // ── Erreurs combat ───────────────────────────────────────────────────────────
  ...
  "inventory.subtitle"           : "Gérez vos sacs et vos objets.",
  "inventory.weight"             : "Poids : {value} kg",
  "inventory.itemCount"          : "{count} objet(s)",
  "inventory.slotsUsed"          : "cases occupées",
  "inventory.empty"              : "Aucun conteneur. Ajoutez un sac pour commencer !",
  "inventory.removeItem"         : "Retirer l'objet",
  "inventory.removeContainer"    : "Supprimer ce conteneur",
  "inventory.resize"             : "Redimensionner",
  "inventory.palette.title"      : "Objets disponibles",
  "inventory.palette.subtitle"   : "Glissez un objet vers la grille ou cliquez dessus.",
  "inventory.custom.title"       : "Objet personnalisé",
  "inventory.custom.subtitle"    : "Créez un objet sur mesure.",
  "inventory.custom.name"        : "Nom",
  "inventory.custom.namePlaceholder" : "Ex. Corde de chanvre",
  "inventory.custom.emoji"       : "Icône",
  "inventory.custom.width"       : "Largeur",
  "inventory.custom.height"      : "Hauteur",
  "inventory.custom.weight"      : "Poids (kg)",
  "inventory.custom.addButton"   : "➕ Ajouter",
  "inventory.addContainer.title"    : "Ajouter un conteneur",
  "inventory.addContainer.subtitle" : "Choisissez un type de sac à ajouter.",
  "inventory.actions.export"     : "Exporter",
  "inventory.actions.import"     : "Charger JSON",
  "inventory.actions.clear"      : "Tout vider",
  "inventory.status.itemAdded"   : "Objet ajouté à l'inventaire.",
  "inventory.status.itemRemoved" : "Objet retiré de l'inventaire.",
  "inventory.status.cleared"     : "Inventaire vidé.",
  "inventory.status.exported"    : "Inventaire exporté avec succès.",
  "inventory.status.imported"    : "Inventaire importé avec succès.",
  "inventory.status.containerAdded"   : "Conteneur ajouté.",
  "inventory.status.containerRemoved" : "Conteneur supprimé.",
  "inventory.status.resized"     : "{name} redimensionné.",
  "inventory.error.gridFull"     : "Plus de place dans ce conteneur.",
  "inventory.error.noContainer"  : "Aucun conteneur disponible.",
  "inventory.error.invalidFile"  : "Fichier d'inventaire invalide.",
  "inventory.error.importFailed" : "Erreur d'import : {error}",
  "inventory.error.nameRequired" : "Le nom de l'objet est obligatoire.",
  "inventory.confirm.clear"      : "Supprimer tous les conteneurs et objets ?",
  "inventory.confirm.import"     : "Importer {count} objet(s) ? L'inventaire actuel sera remplacé.",
  "inventory.confirm.removeContainer"      : "Supprimer « {name} » (vide) ?",
  "inventory.confirm.removeContainerItems" : "Supprimer « {name} » et ses {count} objet(s) ?",
  "inventory.confirm.resizeLoseItems"      : "{count} objet(s) dépassent la nouvelle taille et seront perdus. Continuer ?",
  "inventory.container.pockets"    : "Poches",
  "inventory.container.pouch"      : "Sacoche",
  "inventory.container.backpack"   : "Sac à dos",
  "inventory.container.largeBag"   : "Grand sac",
  "inventory.container.bagHolding" : "Sac sans fond",
  "inventory.item.potion"        : "Potion de vie",
  "inventory.item.staff"         : "Bâton",
  "inventory.item.relic"         : "Relique",
  "inventory.item.sword"         : "Épée",
  "inventory.item.shield"        : "Bouclier",
  "inventory.item.scroll"        : "Parchemin",
  "inventory.item.torch"         : "Torche",
  "inventory.item.ring"          : "Anneau",
  "inventory.item.helmet"        : "Casque",
  "inventory.item.gem"           : "Gemme",
};
