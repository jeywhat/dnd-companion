...
export const fr = {
  ...
  // ── Carte (whiteboard VTT) ───────────────────────────────────────────────
  "nav.carte"              : "Carte",
  "carte.addPlayer"        : "Ajouter un joueur",
  "carte.addMonster"       : "Ajouter un monstre",
  "carte.addNpc"           : "Ajouter un PNJ",
  "carte.toggleGrid"       : "Afficher/masquer la grille",
  "carte.toggleSnap"       : "Activer/désactiver l'aimantation",
  "carte.snapOn"           : "On",
  "carte.snapOff"          : "Off",
  "carte.zoomIn"           : "Zoom avant",
  "carte.zoomOut"          : "Zoom arrière",
  "carte.resetView"        : "Recentrer la vue",
  "carte.tokenAdded"       : "Token {type} ajouté.",
  "carte.tokenDeleted"     : "Token \"{name}\" supprimé.",
  "carte.noPermission"     : "Vous ne pouvez pas déplacer ce token.",
  "carte.myToken"          : "Mon token",
  "carte.placeMyToken"     : "Placer mon token",
  "carte.centerMyToken"    : "Centrer sur mon token",
  "carte.myTokenPlaced"    : "Votre token a été placé sur la carte.",
  "carte.deleteToken"      : "Supprimer le token sélectionné",
  "carte.clearBoard"       : "Vider le plateau",
  "carte.confirmClear"     : "Tout effacer ? Cartes et tokens seront supprimés.",
  "carte.boardCleared"     : "Plateau vidé.",
  "carte.saveView"         : "Sauvegarder la vue",
  "carte.viewSaved"        : "Vue sauvegardée.",
  "carte.dropHint"         : "Glissez une image ici",
  "carte.mapAdded"         : "Carte \"{name}\" ajoutée.",
  "carte.mapError"         : "Erreur lors du chargement de l'image.",
  "carte.toggleMinimap"    : "Afficher/masquer la mini-carte",
