...
export const fr = {
  ...
  // ── Whiteboard (Carte) ────────────────────────────────────────────────────────
  "nav.whiteboard"                       : "Carte",
  "whiteboard.title"                     : "Carte de combat",
  "whiteboard.empty"                     : "Board vide — le MJ peut importer des cartes.",
  "whiteboard.emptyPlayer"               : "Le MJ n'a pas encore chargé de carte.",
  "whiteboard.toolbar.addMap"            : "📂 Ajouter une carte",
  "whiteboard.toolbar.addMapUrl"         : "🔗 Carte URL",
  "whiteboard.toolbar.clearMaps"         : "🗑️ Effacer les cartes",
  "whiteboard.toolbar.addToken"          : "➕ Ajouter un token",
  "whiteboard.toolbar.clearTokens"       : "🧹 Supprimer les tokens",
  "whiteboard.toolbar.syncCamera"        : "📡 Sync vue joueurs",
  "whiteboard.toolbar.unsyncCamera"      : "📡 Libérer la vue",
  "whiteboard.toolbar.resetView"         : "🔄 Réinitialiser vue",
  "whiteboard.tool.select"               : "Sélection (tokens)",
  "whiteboard.tool.pan"                  : "Déplacer la vue",
  "whiteboard.tool.map"                  : "Déplacer les cartes",
  "whiteboard.gridSnap"                  : "Aimant grille",
  "whiteboard.zoom"                      : "Zoom : {pct}%",
  "whiteboard.token.player"              : "Joueur",
  "whiteboard.token.monster"             : "Monstre",
  "whiteboard.token.delete"              : "Supprimer",
  "whiteboard.token.lock"                : "Verrouiller",
  "whiteboard.token.unlock"              : "Déverrouiller",
  "whiteboard.modal.addToken.title"      : "Nouveau token",
  "whiteboard.modal.addToken.name"       : "Nom",
  "whiteboard.modal.addToken.namePlaceholder" : "Gobelin, Orque…",
  "whiteboard.modal.addToken.type"       : "Type",
  "whiteboard.modal.addToken.color"      : "Couleur",
  "whiteboard.modal.addToken.owner"      : "Propriétaire",
  "whiteboard.modal.addToken.ownerNone"  : "— MJ —",
  "whiteboard.modal.addToken.submit"     : "Créer",
  "whiteboard.modal.addToken.cancel"     : "Annuler",
  "whiteboard.modal.addMapUrl.title"     : "Importer une carte depuis une URL",
  "whiteboard.modal.addMapUrl.placeholder" : "https://exemple.com/carte.jpg",
  "whiteboard.modal.addMapUrl.widthLabel" : "Largeur (cases)",
  "whiteboard.modal.addMapUrl.submit"    : "Ajouter",
  "whiteboard.modal.addMapUrl.cancel"    : "Annuler",
  "whiteboard.status.mapAdded"           : "Carte ajoutée : {name}.",
  "whiteboard.status.mapDeleted"         : "Carte supprimée.",
  "whiteboard.status.mapsCleared"        : "Toutes les cartes effacées.",
  "whiteboard.status.tokenAdded"         : "Token \"{name}\" ajouté.",
  "whiteboard.status.tokenDeleted"       : "Token supprimé.",
  "whiteboard.status.tokensCleared"      : "Tous les tokens ont été supprimés.",
  "whiteboard.status.notGm"             : "Seul le MJ peut effectuer cette action.",
  "whiteboard.status.noRoom"            : "Rejoignez une salle pour utiliser la carte.",
  "whiteboard.status.locked"            : "Ce token est verrouillé.",
  "whiteboard.status.notOwner"          : "Vous ne pouvez déplacer que votre propre token.",
  "whiteboard.status.fileTooLarge"      : "Fichier trop volumineux (max 2 Mo).",
  "whiteboard.status.cameraSynced"      : "Vue synchronisée avec les joueurs.",
  "whiteboard.status.cameraFreed"       : "Vue des joueurs libérée.",
  "whiteboard.confirm.clearMaps"        : "Supprimer toutes les cartes du board ?",
  "whiteboard.confirm.clearTokens"      : "Supprimer tous les tokens ?",
  "whiteboard.myToken"                  : "Mon token",
  "whiteboard.dragHint"                 : "Glissez votre token sur la carte",
};
